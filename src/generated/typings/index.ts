...
export type CloudAuth = { provider_id: string, access_token: string, refresh_token: string | null, auth_data: string | null, };
...
export type CloudFolder = { id: string, provider_id: string, cloud_folder_id: string, cloud_folder_name: string, local_folder_path: string, created_at: bigint, updated_at: bigint, };

export type CloudProvider = { id: string, provider_type: string, access_token: string, refresh_token: string | null, auth_data: string | null, created_at: bigint, updated_at: bigint, };

export type CloudSync = { id: string, provider_id: string, folder_id: string, item_id: string, item_type: string, cloud_file_id: string, cloud_file_name: string, local_path: string, last_synced: bigint | null, sync_status: string, created_at: bigint, updated_at: bigint, };
