...
export type CloudFile = { id: string, name: string, parent_id: string | null, size: bigint, is_folder: boolean, modified_at: bigint, created_at: bigint, mime_type: string | null, hash: FileHash | null, display_path: string | null, relative_path: string | null, };
...
export type CloudTrack = { id: string, blake3_hash: string | null, old_blake3_hashes: Array<string>, cloud_file_id: string | null, created_at: bigint, updated_at: bigint, tags: CloudTrackTag | null, };
