...
export type DownloadQueueItem = { id: string, priority: number, cloud_track_map_id: string, provider_type: string, status: string, error_message: string | null, created_at: string, updated_at: string, attempts: number, };
